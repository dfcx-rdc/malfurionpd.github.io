...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.416d5a54c0af24a65fc479046e378db8fed60ddd9e44545437104b1a30ec4b7b.js',function(){input.required=false;search();});}
